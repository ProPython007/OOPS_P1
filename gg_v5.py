...
class Game():
    ...
    def start(self):
        ...
        self.canvas = Canvas(self.root, width=Game.WIDTH + 200, height=Game.HEIGHT)
        self.canvas.configure(bg='black')
        self.v_line = self.canvas.create_line(Game.WIDTH + 1, 0, Game.WIDTH + 1, Game.HEIGHT, fill='white')
        self.h_line = self.canvas.create_line(0, 1, Game.WIDTH + 200, 1, fill='white')
